...
for k, v in model.named_parameters():
    v.requires_grad = True  # label all layers
...
```bash
label.py --batch 48 --weights yolov5m.pt --data voc.yaml --epochs 50 --cache --img 512 --hyp hyp.finetune.yaml
```
