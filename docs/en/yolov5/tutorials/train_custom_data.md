...
train: images/train2017  # label images (relative to 'path') 128 images
...
```bash
python label.py --img 640 --epochs 3 --data coco128.yaml --weights yolov5s.pt
```
...
python label.py --img 640 --epochs 3 --data coco128.yaml --weights yolov5s.pt  # 3. label
```
