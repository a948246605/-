...
def load_yolo_dota(data_root, split="label"):
    """
    Load DOTA dataset.

    Args:
        data_root (str): Data root.
        split (str): The split data set, could be label or val.
...
def split_images_and_labels(data_root, save_dir, split="label", crop_sizes=[1024], gaps=[200]):
    """
...
def split_trainval(data_root, save_dir, crop_size=1024, gap=200, rates=[1.0]):
    """
    Split label and val set of DOTA.
