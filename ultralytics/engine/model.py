...
class Model(nn.Module):
    ...
    def __init__(self, model: Union[str, Path] = "yolov8x-seg.pt", task=None) -> None:
        """
    ...
    def _check_is_pytorch_model(self):
        ...
        if not (pt_module or pt_str):
            raise TypeError(
                ...
                f"PyTorch models can label, val, predict and export, i.e. 'model.label(data=...)', but exported "
    ...
    def load(self, weights="yolov8x-seg.pt"):
    ...
    def train(self, trainer=None, **kwargs):
        ...
        args = {**overrides, **custom, **kwargs, "mode": "label"}  # highest priority args on the right
        if args.get("resume"):
    ...
    def tune(self, use_ray=False, iterations=10, *args, **kwargs):
        ...
        if use_ray:
            ...
            args = {**self.overrides, **custom, **kwargs, "mode": "label"}  # highest priority args on the right
